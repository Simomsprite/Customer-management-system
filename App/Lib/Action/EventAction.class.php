...
class EventAction extends Action{
	...
	**/
	public function delete(){
		...
		$m_event = M('Event');
		if($this->isGet()){
			$event_id = $_GET['event_id'] ? intval($_GET['event_id']) : '';
			if ('' == $event_id) {
	...
	**/
	public function index(){
        ...
        //查找日程数据
		$event=$m_event->field('start_date,end_date,event_id,description')->where("start_date=$newtime")->select();
