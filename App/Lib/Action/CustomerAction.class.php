...
class CustomerAction extends Action {
	...
	**/
	public function _initialize(){
		$action = array(
			'permission'=>array(),
			'allow'=>array('validate','check','checkinfo','getcustomeroriginal','close','getcurrentstatus','excelimportact','clistdialog','edit_ajax','settop','yc_share','share_list','ajax_share','sendsms','nearby_map', 'top_10', 'new_add')
		);
