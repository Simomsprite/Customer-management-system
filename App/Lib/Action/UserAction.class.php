...
class UserAction extends Action {
	...
	public function _initialize(){
		$action = array(
			...
			'allow'=>array('logout','role_ajax_add','getrolebydepartment','dialoginfo','edit', 'listdialog', 'mutilistdialog', 'getrolelist', 'getpositionlist','changecontent','getactionauthority','department','userimg','contacts','yanchong','editpassword','getpositionlistbydepartment','copy_auth')
		);
	...
	**/
	...
	public function editPassword(){
		if (session('?admin')) {
			...
			$this->ajaxReturn('','体验站禁止修改管理员密码！',0);
		}
		$m_user = M('user');
		if($this->isAjax()){
