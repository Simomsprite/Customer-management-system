	...
	class ContactsViewModel extends ViewModel {
		public function _initialize(){
			...
			$this->viewFields = array(  
				...
				'r_contacts_customer'=>array('customer_id','_on'=>'r_contacts_customer.contacts_id=contacts.contacts_id','_type'=>'LEFT'),
				'customer'=>array('name'=>'customer_name','owner_role_id', '_on'=>'r_contacts_customer.customer_id=customer.customer_id')
			);
		}
	} 