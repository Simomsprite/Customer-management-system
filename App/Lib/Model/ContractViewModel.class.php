	...
	class ContractViewModel extends ViewModel {
		...
		public function _initialize(){
			...
			$this->viewFields = array(
				...
				'market' => array('_type' => 'LEFT', '_on' => 'contract.market_id=market.market_id', 'name' => 'market_name'),
				'user'=>array('_type' => 'LEFT', 'full_name' => 'owner_name', '_on' => 'contract.owner_role_id=user.role_id'),
			);
		}
	}