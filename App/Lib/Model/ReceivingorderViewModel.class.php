<?php 
	class ReceivingorderViewModel extends ViewModel{
		public $viewFields = array(
			...
			'receivables'=>array('name'=>'receivables_name','payer','type'=>'receivables_type','customer_id','contract_id', '_on'=>'receivingorder.receivables_id=receivables.receivables_id','_type'=>'LEFT'),
