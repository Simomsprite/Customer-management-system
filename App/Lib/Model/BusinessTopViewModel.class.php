<?php 
	class BusinessTopViewModel extends ViewModel{
		...
		public function _initialize(){
			...
			$business_status = array('order_id','is_end', '_on' => 'business.status_id=business_status.status_id');

			$this->viewFields = array('business'=>$data_list,'top'=>$data_top, 'business_status' => $business_status);
		}
