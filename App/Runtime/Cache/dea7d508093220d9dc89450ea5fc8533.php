						...
						<div class="col-md-11 add_body_form">
							<?php if(is_array($field_list['main'])): $key = 0; $__LIST__ = $field_list['main'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="form-group">
									...
									<?php if($vo['field'] == 'customer_owner_id'): ?><div class="col-md-6">
											...
											<input class="form-control required valid" aria-required="true" id="owner_name" name="owner_name" type="text" value="<?php echo (session('full_name')); ?>" readonly="true" style="cursor:pointer;" title="请点击选择" aria-invalid="false">
										</div>
										<div class="col-md-2"><span style="color: red;line-height: 32px;margin-left: 10px;">*</span></div>
									<?php elseif($vo['field'] == 'customer_code'): ?>
										<div class="col-md-6">
											<input class="form-control required" type="text" id="customer_code" name="customer_code" value="<?php echo ($customer_code); ?>" aria-required="true">
