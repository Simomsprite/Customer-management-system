							...
							<li>
								<div class="input-group">
									<select class="form-control" onchange="window.open(this.options[this.selectedIndex].value,target='_self')" style="margin-bottom:5px;">
										<option value="<?php echo U('finance/index','&'.$status_parameter);?>" <?php if($_GET['status']['value'] == '' ): ?>selected="selected"<?php endif; ?>>全部</option>
										<option value="<?php echo U('finance/index','status[value]=3&'.$status_parameter);?>" <?php if($_GET['status']['value'] == '3'): ?>selected="selected"<?php endif; ?>>未收款</option>
										<option value="<?php echo U('finance/index','status[value]=1&'.$status_parameter);?>" <?php if($_GET['status']['value'] == '1'): ?>selected="selected"<?php endif; ?>>部分已收</option>
										<option value="<?php echo U('finance/index','status[value]=2&'.$status_parameter);?>" <?php if($_GET['status']['value'] == '2'): ?>selected="selected"<?php endif; ?>>已完成</option>
									</select>
								</div>
							</li>
						</ul>
							...
							<li>
								<div class="input-group" style="margin-right: 10px;margin-bottom: 5px;">
									<select class="form-control" onchange="window.open(this.options[this.selectedIndex].value,target='_self')" >
										<option value="<?php echo U('finance/index','by=me&'.$by_parameter);?>" <?php if($_GET['by'] == 'me' || $_GET['by'] == ''): ?>selected="selected"<?php endif; ?>>我的应收款</option>
										<option value="<?php echo U('finance/index','by=sub&'.$by_parameter);?>" <?php if($_GET['by'] == 'sub'): ?>selected="selected"<?php endif; ?>>下属应收款</option>
										<option value="<?php echo U('finance/index','by=all&'.$by_parameter);?>" <?php if($_GET['by'] == 'all'): ?>selected="selected"<?php endif; ?> <?php if($_GET['by'] == ''): ?>selected="selected"<?php endif; ?> >全部应收款</option>
									</select>
								</div>
							</li>
							<li>
								...
								<div class="input-group">
									...
									<input type="hidden" name="status[value]" value="<?php echo ($_GET['status']['value']); ?>"/>
									<input id="short_search" type="text" style="width:160px;" placeholder="请输入应收款编号" onkeydown='if(event.keyCode==13) {$("#short_search_btn").trigger("click");return false;}' class="form-control input-sm" name="search" <?php if($_GET['field'] == 'name'): ?>value="<?php echo ($_GET['search']); ?>"<?php endif; ?>/>
	...
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
										...
										<?php else: ?>
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
													...
													<td style="color:#F57462;font-weight:700;vertical-align:middle;">
														<a style="color:#F57462;" href="<?php echo U('finance/view','t=receivables&id='.$vo['receivables_id']);?>"><span class="pull-left"><?php echo (number_format($vo['un_payable'],2)); ?></span></a>
														<a class="add_receivingorder pull-right" data-toggle="tooltip" data-placement="right" data-original-title="添加回款" rel="<?php echo ($vo["receivables_id"]); ?>" style="color:#8FA1B2;font-size:20px;margin-right:20px;margin-top:-4px;"><i class="fa fa-plus-square-o"></i></a>
													</td>
													<td style="color:#8ED167;font-weight:700"><?php echo (number_format($vo['price'],2)); ?></td>
													<td>
														<?php echo ($vo['type_name']); ?>
													</td>
													<td class="project-completion">
		                                                <small>当前进度：<?php echo ($vo['schedule']); ?>%</small>
		                                                <div class="progress progress-mini">
		                                                    <div style="width: <?php echo ($vo['schedule']); ?>%;" class="progress-bar"></div>
		                                                </div>
			                                        </td>
													<td>
														<?php if($vo['type'] == 2): ?><a href="<?php echo U('supplier/view','id='.$vo['customer_id']);?>" target="_blank"><?php echo ($vo["supplier_name"]); ?></a>
														<?php elseif($vo['type'] == 1): ?>
															<a href="<?php echo U('customer/view','id='.$vo['customer_id']);?>" target="_blank"><?php echo ($vo["customer_name"]); ?></a>
														<?php else: ?>
															<?php echo ($vo["payer"]); endif; ?>
													</td>
													<td><?php echo (date("Y-m-d",$vo["pay_time"])); ?></td>
													<td><a href="<?php echo U('finance/view','t=receivables&id='.$vo['receivables_id']);?>"><?php echo ($vo["name"]); ?></a></td>
													<td>
														<?php if($vo['type'] == 1): ?><a href="<?php echo U('contract/view','id='.$vo['contract_id']);?>"><?php echo ($vo["contract_number"]); ?></a>
														<?php else: ?>
															<a href="<?php echo U('purchase/return_goods_view','id='.$vo['contract_id']);?>" target="_blank"><?php echo ($vo['purchase_return_name']); ?></a><?php endif; ?>
													</td>
													<td><a class="role_info" rel="<?php echo ($vo['owner']['role_id']); ?>" href="javascript:void(0)"><?php echo ($vo['owner']['full_name']); ?></a></td>
								...
								<div id="tfoot_div" class="clearfix">
									<div class="clearfix" id="tfoot_page">	
										...
										<?php if($fields_search): ?><span class="pull-left" style="margin-left:10px;margin-top:10px;">本次搜索结果<span style="color:#F8AC59"> <?php echo ($count); ?> </span>条数据<a href="<?php echo U('finance/index','t=receivables');?>" class="btn" style="background:#fff;border:1px solid #ccc;margin-left:10px;color:#999;" id="clearnumber">清除搜索条件</a></span><?php endif; ?>
					...
					<ul class="nav pull-left" style="margin:0px 0 0 5px;width:620px;">
						<li class="pull-left">
							<select id="field_<?php echo ($key1); ?>" style="width:auto" class="form-control input-sm field_name new-select" onchange="changeCondition(<?php echo ($key1); ?>)" >
								<option class="" value="name">--请选择条件--</option>
								<option class="word" <?php if($vo['field'] == 'name'): ?>selected="selected"<?php endif; ?> value="name">应收款编号</option>	
								<option class="word" <?php if($vo['field'] == 'customer_name'): ?>selected="selected"<?php endif; ?> value="customer_name"><?php echo L('CUSTOMER');?>名称</option>							
								<option class="word" <?php if($vo['field'] == 'contract_name'): ?>selected="selected"<?php endif; ?> value="contract_name">合同编号</option>							
								<option class="number" <?php if($vo['field'] == 'price'): ?>selected="selected"<?php endif; ?> value="price"><?php echo L('AMOUNT OF RECEIVING');?></option>
								<option class="date" <?php if($vo['field'] == 'pay_time'): ?>selected="selected"<?php endif; ?> value="pay_time">应收款时间</option>
								<option class="receivables_status" <?php if($vo['field'] == 'status'): ?>selected="selected"<?php endif; ?> value="status"><?php echo L('STATUS');?></option>
								<option class="role" <?php if($vo['field'] == 'owner_role_id'): ?>selected="selected"<?php endif; ?> value="owner_role_id"><?php echo L('OWNER_ROLE');?></option>
								<option class="role" <?php if($vo['field'] == 'creator_role_id'): ?>selected="selected"<?php endif; ?> value="creator_role_id"><?php echo L('CREATOR_ROLE');?></option>						
						...
						<?php elseif($vo["field"] == 'owner_role_id' || $vo["field"] == 'creator_role_id'): ?>
						...
						<?php elseif($vo["form_type"] == 'datetime' || $vo["field"] == 'status'): ?>
						...
						<?php if($vo["form_type"] != 'box' && $vo["form_type"] != 'address'): if($vo["form_type"] == 'datetime'): ?><input id="start_<?php echo ($vo['field']); ?>" type="text" class="form-control input-sm search-query" name="<?php echo ($vo['field']); ?>[start]" onclick="WdatePicker()" value="<?php echo ($fields_search[$vo['field']][start]); ?>" rel="receivables"/> 至 <input id="end_<?php echo ($vo['field']); ?>" type="text" class="form-control input-sm search-query" name="<?php echo ($vo['field']); ?>[end]" onclick="WdatePicker()" value="<?php echo ($fields_search[$vo['field']][end]); ?>" rel="receivables"/>
							<?php elseif($vo["field"] == 'status'): ?>
								<select class="form-control input-sm" id="search_<?php echo ($key1); ?>" rel="<?php echo ($fields_search['status']['value']); ?>" style="width:auto" name="<?php echo ($vo['field']); ?>[value]">
									<option value="0">未收款</option>
									<option value="1">部分已收</option>
									<option value="2">已完成</option>
								</select>
								<script type="text/javascript">
									var key_id = <?php echo ($key1); ?>;
