...
<div class="clearfix" id="userlist_dialog_child">
...
<script type="text/javascript">
	...
	$('#go_page').change(function(){
		...
		$('#userlist_dialog_child').parent().load(sel);
		return false;
	});
	$(function(){
		$('#footers a').click(function(){ 
			...
			$('#userlist_dialog_child').parent().load(rel);
			return false;
		});
	});
	...
	function changeCondition1(){
		...
		$('#userlist_dialog_child').parent().load('index.php?'+$("#dd").serialize());
	}
</script>