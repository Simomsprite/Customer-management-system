...
<div class="wrap-box">
    ...
    <form  action="<?php echo U('leadsm/save');?>" method="post" >
        ...
        <ul class="cust-form">
            <?php if(is_array($field_list['main'])): $key = 0; $__LIST__ = $field_list['main'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key; if($vo["in_add"] == '1'): ?><li class="titbox">
                    ...
                    <?php if($vo['form_type'] == 'textarea'): if($vo['tip_start'] == 1): ?><div class="col-md-6">
                        ...
                        <?php if($vo['tip_start'] == 1): ?><div class="col-md-2"></div>
                            <?php else: ?>
                            <div class="col-md-2"></div><?php endif; endif; endif; ?>
