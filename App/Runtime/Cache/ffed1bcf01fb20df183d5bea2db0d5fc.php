			...
			<div class="title-bar" style="padding:12px 10px 12px 20px">
				<div class="row " id="title-show">
					<ul class="nav pull-left" style="margin:2px 0 5px 15px;">
						...
						<span style="font-size:21px;" id="demo_name"><?php echo (date('Y-m-d',$current_time)); echo L('WORKING_LOG');?></span>
					</ul>
				</div>
			</div>
			<div class="col-sm-7" style="background-color:#fff;border: 1px solid #ccc;">
				<form action="<?php echo U('log/mylog_add');?>" method="post" id="form1">
					<input type="hidden" name="creator_id" value="<?php echo (session('user_id')); ?>"/>
					<div class="ibox-title clearfix" style="">
						<div class="pull-left">
							<em style="color:#999;font-size:15px;"><?php echo session('full_name');?>，工作一天辛苦了！</em>
						</div>
						<div class="pull-right">
							<select name="category_id" class="form-control" style="width:150px;line-height:40px;color:#999;">
								<option value="4">日报</option>
						...
						<tfoot>
							<tr> 
								...
								<td style="border-style:none;text-align: right;">
									...
									<input class="btn btn-default btn-sm" onclick="javascript:history.go(-1)" type="reset" value="<?php echo L('CANCEL');?>" />
								</td>					
							</tr>
						</tfoot>
						<tbody >
							<tr >
								...
								<td style="width:90%"><input type="text" class="form-control" name="subject" id="subject" maxlength="20" style="width:250px;" value="<?php echo (date('Y-m-d',$current_time)); ?> <?php echo L('WORKING_LOG');?>" oninput="document.getElementById('demo_name').innerHTML=this.value;" onpropertychange="document.getElementById('demo_name').innerHTML=this.value;"></td>		
							</tr>
							<tr>
								<td class="tdleft" style="vertical-align: top;border-top-style: none;">内容：</td>
								<td style="border-top-style: none;">
									<textarea rows="12" class="form-control" style="width:99.2%;padding: 15px;" id="log_content" name="content" placeholder="请填写今日工作总结"></textarea>
									<div class="test_div">
				...
				<div class="ibox-content">
					...
					<div class="ibox-content container-fluid ">
						<div class="col-sm-12">
							<div class="col-sm-3">
								<span>新增客户</span>
								<div style="margin-top:10px;"><span style="font-size:20px;"><?php echo ($anly_count['customer_count']); ?></span>个</div>
							</div>
							<div class="col-sm-3">
								<span>新增联系人</span>
								<div style="margin-top:10px;"><span style="font-size:20px;"><?php echo ($anly_count['contacts_count']); ?></span>个</div>
							</div>
							<div class="col-sm-3">
								<span>新增商机</span>
								<div style="margin-top:10px;"><span style="font-size:20px;"><?php echo ($anly_count['business_count']); ?></span>个</div>
							</div>
							<div class="col-sm-3">
								<span>沟通日志</span>
								<div style="margin-top:10px;"><span style="font-size:20px;"><?php echo ($anly_count['log_count']); ?></span>个</div>
							</div>
					...
					<div class="ibox-content container-fluid ">
						<div class="col-sm-12">
							<div class="col-sm-4">
								<span>签订合同</span>
								<div style="margin-top:10px;color:#1985DC;"><span style="font-size:20px;"><?php echo ($anly_count['contract_count']); ?></span>个</div>
							</div>
							<div class="col-sm-4">
								<span>回款总金额</span>
								<div style="margin-top:10px;"><span style="font-size:20px;"><?php echo ($anly_count['receivingorder_sum']); ?></span>元</div>
							</div>
							<div style="clear:both;"></div>
						</div>
					</div>
