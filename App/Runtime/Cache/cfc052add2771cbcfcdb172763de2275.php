...
<div class="wrap-box">
    ...
    <form action="<?php echo U('eventm/add');?>" method="post">
        <ul class="cust-form">
            <li class="titbox">
            ...
            <li class="titbox">
                ...
                <div class="txtbox">
                    <input type="text" class="txt ptxt100p" placeholder="请选择开始时间" value="<?php echo ($start_date); ?>"  name="start_date" id="USER_AGE">
                </div>
            </li>
            <li class="titbox">
                <span class="tit">结束时间：</span>
                <div class="txtbox">
                    <input type="text" class="txt ptxt100p" placeholder="请选择结束时间" value="<?php echo ($end_date); ?>" name="end_date" id="USER_AGE1">
                </div>
            </li>
            <li class="titbox">
