...
<div class="content-login">
    <div class="logininfo">
	    <div class="logininfowidth">
	        <div class="loginrq ">
	            <a href="javascript:;">
	               	<img <?php if($logo): ?>src= "<?php echo ($logo); ?>"<?php else: ?>src= "__PUBLIC__/img/lclg.png"<?php endif; ?> style="width: 240px;height:65px;" />
	            </a>
	        </div>
		    <form action="" class="formtheme" method="post" id="login_form">
			    <div class="logininputList logininputListUser">
			        <input type="text" class="inputinfo" name="name" id="name" placeholder="账号" autofocus="autofocus">
			     </div>
		    ...
		    <p style="text-align: center;top:180px;position: relative;">
		    	<a href="#" target="_blank"><small>&copy;<?php echo date('Y',time());?> 上海联朝网络科技有限公司</small></a>
		 	</p>
	    </div>     
    </div>
</div></div>
