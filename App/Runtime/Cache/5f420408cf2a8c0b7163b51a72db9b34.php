...
<div class="wrap-box" style="padding-top: 0;">
  
    <div class="swiper-container abe-pic-slider">
        <div class="swiper-wrapper">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><a href="<?php echo ($vo["url"]); ?>"><<img src="<?php echo headPathHandle($vo['img_path']);?>"></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
