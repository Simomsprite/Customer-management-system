...
<script>
$(function(){
	<?php if($_GET['content_id'] == 1 || $_GET['content_id'] == ''): ?>$("#table_div").height(window.innerHeight-$("#table_div").offset().top-30);
		$(window).resize(function(){
 ...
 $module_name = strtolower(MODULE_NAME); $action_name = strtolower(ACTION_NAME); $content_id = intval($_GET['content_id']); ?>
		<div class="subNavBox">
			...
			<ul class="navContent" style="display:block">
				<li >
					<a class="color1 <?php if($module_name == "customer" && $action_name == "analytics" && ($content_id == 1 || $content_id == "")): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/analytics','content_id=1');?>"><span class="li_text">员工客户分析</span></a>
				</li>
				<li >
					<a class="<?php if($module_name == "customer" && $action_name == "analytics" && $content_id == 2): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/analytics','content_id=2');?>"><span class="li_text">客户自定义分析</span></a>
				</li>
				<li >
					<a class="<?php if($module_name == "customer" && $action_name == "top_10"): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/top_10');?>"><span class="li_text">签约客户TOP10</span></a>
				</li>
				<li >
					<a class="<?php if($module_name == "customer" && $action_name == "new_add" && ($content_id == 1 || $content_id == "")): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/new_add');?>&content_id=1"><span class="li_text">新增客户数分析</span></a>
				</li>
				<li >
					<a class="<?php if($module_name == "customer" && $action_name == "new_add" && $content_id == 2): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/new_add');?>&content_id=2"><span class="li_text">客户成交率分析</span></a>
				</li>
				<li >
					<a class="<?php if($module_name == "customer" && $action_name == "new_add" && $content_id == 3): ?>li_text_active<?php endif; ?>" href="<?php echo U('customer/new_add');?>&content_id=3"><span class="li_text">客户区域分析</span></a>
				</li>
			</ul>
			<div rel="business" class="subNav currentDd currentDt">客户过程分析</div>
			<ul class="navContent" style="display:block">
				<li >
					<a class="<?php if($module_name == "business" && $content_id == 1): ?>li_text_active<?php endif; ?>" href="<?php echo U('business/analytics','content_id=1');?>"><span class="li_text">员工商机分析</span></a>
				</li>
				<li >
				...
				<li >
					<a class="<?php if($module_name == "business" && $action_name == "trend_number"): ?>li_text_active<?php endif; ?>" href="<?php echo U('business/trend_number');?>"><span class="li_text">商机数量趋势分析</span></a>
				</li>
				<li>
					<a class="<?php if($module_name == "business" && $action_name == "trend_money"): ?>li_text_active<?php endif; ?>" href="<?php echo U('business/trend_money');?>"><span class="li_text">商机金额趋势分析</span></a>
				</li>
				<li>
					<a class="<?php if($module_name == "business" && $action_name == "map_number"): ?>li_text_active<?php endif; ?>" href="<?php echo U('business/map_number');?>"><span class="li_text">商机区域分布分析</span></a>
				</li>
			</ul>
			<div rel="finance" class="subNav currentDd currentDt">客户结果分析</div>
			<ul class="navContent" style="display:block">
				<li >
					<a class="<?php if($module_name == "contract" && $action_name == "analysis_number"): ?>li_text_active<?php endif; ?>" href="<?php echo U('contract/analysis_number');?>"><span class="li_text">合同数量统计</span></a>
				</li>
				<li >
				...
				<li >
					<a class="<?php if($module_name == "contract" && $action_name == "received_top10"): ?>li_text_active<?php endif; ?>" href="<?php echo U('contract/received_top10');?>"><span class="li_text">回款金额TOP10</span></a>
				</li>
			</ul>
			...
			<ul class="navContent" rel="contract" style="display:block;margin-bottom:0px;">
				...
				<li >
					<a class="color1 <?php if($module_name == "contract" && $action_name == "target_rank"): ?>li_text_active<?php endif; ?>" href="<?php echo U('contract/target_rank');?>"><span class="li_text">目标完成率排行榜</span></a>
				</li>
			</ul>
			...
			<ul class="navContent" rel="report" style="display:block;margin-bottom:0px;">
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'contract_amount'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=contract_amount');?>"><span class="li_text">合同金额排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'receive_amount'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=receive_amount');?>"><span class="li_text">回款金额排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'contract_count'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=contract_count');?>"><span class="li_text">签约合同数排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'contract_product_count'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=contract_product_count');?>"><span class="li_text">产品销量排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'customer_add'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=customer_add');?>"><span class="li_text">新增客户数排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'contacts_add'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=contacts_add');?>"><span class="li_text">新增联系人数排行榜</span></a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == 'report' && $_GET['rank_type'] == 'follow_count'): ?>li_text_active<?php endif; ?>" href="<?php echo U('report/rank','rank_type=follow_count');?>"><span class="li_text">跟进次数排行榜</span></a>
				</li>
			</ul>
			...
			<ul class="navContent" rel="contract" style="display:block;margin-bottom:0px;">
				<li>
					<a class="color1 <?php if($module_name == "product" && $action_name == "product_analytics"): ?>li_text_active<?php endif; ?>" href="<?php echo U('product/product_analytics');?>">
						<span class="li_text">产品销售统计</span>
					</a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == "product" && $action_name == "sales_volume_analytics"): ?>li_text_active<?php endif; ?>" href="<?php echo U('product/sales_volume_analytics');?>">
						<span class="li_text">单产品销量、销售额分析</span>
					</a>
				</li>
				<li>
					<a class="color1 <?php if($module_name == "product" && $action_name == "top_10"): ?>li_text_active<?php endif; ?>" href="<?php echo U('product/top_10');?>">
			...
			<ul class="navContent" style="display:block">
				<li >
					<a class="color1 <?php if($module_name == "purchase" && ($content_id == 1 || $content_id == "")): ?>li_text_active<?php endif; ?>" href="<?php echo U('purchase/analytics');?>"><span class="li_text">采购产品汇总</span></a>
				</li>
			</ul>
			<!-- <div rel="stock" class="subNav currentDd currentDt">库存数据分析</div>
			<ul class="navContent" style="display:block">
				<li >
					<a class="color1 <?php if($module_name == "stock" && ($content_id == 1 || $content_id == "")): ?>li_text_active<?php endif; ?>" href="<?php echo U('stock/analytics','content_id=1');?>"><span class="li_text">商品收发汇总</span></a>
				</li>
			</ul> -->
			...
			<ul class="navContent" style="display:block">
				...
				<li >
					<a class="<?php if($module_name == "remind" && $action_name == "visitor_plan_analytics"): ?>li_text_active<?php endif; ?>" href="<?php echo U('remind/visitor_plan_analytics');?>">
						<span class="li_text">访客计划</span>
					</a>
				</li>
				<?php $call_setting = C('CALL_SETTING'); if ($call_setting['CENTER'] == 1): ?>
					<li>
						<a <?php if($module_name == 'call' && $action_name == 'record' ): ?>class="li_text_active"<?php endif; ?> href="<?php echo U('call/record');?>"><span class="li_text">电话记录</span></a>
					</li>
					<li>
						<a <?php if($module_name == 'call' && $action_name == 'analytics' ): ?>class="li_text_active"<?php endif; ?> href="<?php echo U('call/analytics');?>"><span class="li_text">电话记录分析</span></a>
					</li>
				<?php endif; ?>
			</ul>
		</div>
	...
	function changeRole(){
		...
		$.ajax({
			...
			success:function(data){
				...
				$("#role").html(options);
				$('#select2-role-container').attr('title', '<?php echo L("All");?>');
				$('#select2-role-container').html('<?php echo L("All");?>');
								...
								<div class="col-lg-4">
									<div class="pull-left" >
										<span style="font-size: 18px;color: #000;">
											<?php
 switch($_GET['content_id']){ case 1:$content_name = '员工商机分析';break; case 2:$content_name = '销售漏斗分析（按创建时间）';break; default : $content_name = '员工商机分析';break; } echo $content_name; ?>
										</span>
									</div>
								</div>
								...
								<div class="col-lg-3">
									<div class="pull-right" >
										<?php if($_GET['content_id'] == 2): ?><div class="pull-left" >
										...
										<div class="pull-left" style="line-height: 40px;">
											<?php if($_GET['content_id'] == 1): ?><span class="fa fa-download" style="color:#75899D;"></span>
												<a style="color: #75899D;" onClick ="$('#tab_Test3').tableExport({type: 'excel', escape: 'false', self: $(this)});">导出</a>
											<?php elseif($_GET['content_id'] == 2 && $_GET['dbname'] == ''): ?>
												<span class="fa fa-download" style="color:#75899D;"></span>
												<a style="color: #75899D;" onClick ="$('#export').tableExport({type: 'excel', escape: 'false', self: $(this)});">导出</a><?php endif; ?>
										</div>
									</div>
									<div class="pull-right" style="margin-right: 15px; margin-top: 10px;">
										<div class="checkbox checkbox-primary">
											<input type="hidden" name="user_range" value="<?php echo ($_GET['user_range']); ?>" />
											<input id="user_range" type="checkbox" <?php if($_GET['user_range'] == 'sale'): ?>checked<?php endif; ?> />
							...
							<div class="row">
								<div class="col-lg-12" >
									...
									<?php if($_GET['content_id'] == 2): ?><div class="nav pull-left" style="margin:2px 0 0 15px;width: 165px;">
											<div class="input-group">
												<select class="form-control" style="min-width:165px;max-width: 165px;line-height: 35px;" name="status_type_id" id="status_type_id" >
													<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($_GET['status_type_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
										</div><?php endif; ?>
					...
					<div class="ibox-content clearfix" id="right_height" style="border-top: none;">
						<?php if($_GET['content_id'] == '' || $_GET['content_id'] == 1): ?><div id="content_1" class="th_content" style="position:relative;">
									...
									<table class="table table-hover table-striped table_thead_fixed table-bordered" id="tab_Test3" style="background:#fff;margin-bottom:0px;">
										...
										<tbody>
											<?php if(is_array($reportList)): $i = 0; $__LIST__ = $reportList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
													...
													<!-- <td><a href="<?php echo U('business/index');?>&field=owner_role_id&search=<?php echo ($vo["user"]["role_id"]); ?>&by=me"><?php echo ($vo["own_count"]); ?></a></td> -->
													<td>
														<?php if($vo['own_count'] != 0): ?><a href="<?php echo U('business/index');?>&owner_role_id=<?php echo ($vo['user']['role_id']); ?>&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>" target="_blank">
																<?php echo ($vo["own_count"]); ?>
															</a>
														<?php else: ?>
															0<?php endif; ?>
													</td>
													<td>
														<?php if($vo['follow_count'] != 0): ?><a href="<?php echo U('business/index');?>&owner_role_id=<?php echo ($vo['user']['role_id']); ?>&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($follow_status_ids); ?>" target="_blank">
																<?php echo ($vo["follow_count"]); ?>
															</a>
														<?php else: ?>
															0<?php endif; ?>
													</td>
													<td>
														<?php if($vo['success_count'] != 0): ?><a href="<?php echo U('business/index');?>&owner_role_id=<?php echo ($vo['user']['role_id']); ?>&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($success_status_ids); ?>" target="_blank">
																<?php echo ($vo["success_count"]); ?>
															</a>
														<?php else: ?>
															0<?php endif; ?>
													</td>
													<td>
														<?php if($vo['deal_count'] != 0): ?><a href="<?php echo U('business/index');?>&owner_role_id=<?php echo ($vo['user']['role_id']); ?>&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($success_status_ids); ?>" target="_blank">
																<?php echo ($vo["fail_status_ids"]); ?>
															</a>
														<?php else: ?>
															0<?php endif; ?>
													</td>
													<td><?php echo ($vo["business_rate"]); ?>%</td>
													<td><?php echo number_format($vo['contract_price'], 2);?></td>
													<td><?php echo number_format($vo['contract_average'], 2);?></td>
													<td><?php echo number_format($vo['receivingorder_price'], 2);?></td>
													<td><?php echo number_format($vo['un_receivingorder_price'], 2);?></td>
											...
											<tr style="background: #70B4E8;color: #fff;font-size: 13px;">
												...
												<td style="color:#fff;">
													<?php if($total_report['own_count_total'] != 0): ?><a href="<?php echo U('business/index');?>&by=all&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>" target="_blank">
															<?php echo ($total_report['own_count_total']); ?>
														</a>
													<?php else: ?>
														0<?php endif; ?>
												</td>
												<td style="color:#fff;">
													<?php if($total_report['follow_count_total'] != 0): ?><a href="<?php echo U('business/index');?>&by=all&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($follow_status_ids); ?>" target="_blank">
															<?php echo ($total_report['follow_count_total']); ?>
														</a>
													<?php else: ?>
														0<?php endif; ?>
												</td>
												<td style="color:#fff;">
													<?php if($total_report['success_count_total'] != 0): ?><a href="<?php echo U('business/index');?>&by=all&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($success_status_ids); ?>" target="_blank">
															<?php echo ($total_report['success_count_total']); ?>
														</a>
													<?php else: ?>
														0<?php endif; ?>
													<a href="">
												...
												<td style="color:#fff;">
													<?php if($total_report['deal_count_total'] != 0): ?><a href="<?php echo U('business/index');?>&by=all&create_time[form_type]=date&create_time[start]=<?php echo ($start_date); ?>&create_time[end]=<?php echo ($end_date); ?>&status_id[condition]=in&status_id[value]=<?php echo ($success_status_ids); ?>" target="_blank">
															<?php echo ($total_report['deal_count_total']); ?>
														</a>
													<?php else: ?>
														0<?php endif; ?>
												</td>
												<td style="color:#fff;"><?php echo ($total_report['business_rate_total']); ?>%</td>
												<td style="color:#fff;"><?php echo ($total_report['contract_price_total']); ?></td>
												<td style="color:#fff;"><?php echo ($total_report['contract_average_total']); ?></td>
												<td style="color:#fff;"><?php echo ($total_report['receivingorder_price_total']); ?></td>
												<td style="color:#fff;"><?php echo ($total_report['un_receivingorder_price_total']); ?></td>
												<td style="color:#fff;"><?php echo ($total_report['receivingorder_rate_total']); ?>%</td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<?php if($_GET['content_id'] == 2): ?><div id="content_2" class="th_content full-height-scroll">
								<?php if($_GET['select_type'] > 0): ?><div id="canvas_status_duibi" class="col-sm-12 sort-list ui-sortable " style="min-width:100%;margin:0 auto;">
										<?php if(is_array($duibi_array)): $key = 0; $__LIST__ = $duibi_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="col-sm-6 sort-item" rel="<?php echo ($key); ?>" style="padding:0px;height: 400px;margin-top: 20px;">
												<div class="dash-border" style="margin:20px;">
													<div class="dash-title" style="padding:15px;width:80%;margin:0px 10%;">
														...
														<span>
															<?php echo ($vo['user']['user_name']); ?>
														</span>
													</div>
													<div class="content-chart" id="sales_funnel_<?php echo ($key); ?>" style="font-size: 12px;width:80%;height: 350px;margin:0px 10%;">
										...
										<div class="full-height-scroll" style="left:0px;top:0px;">
											<table class="table table-hover" id="export" style="margin-top: 20px;border:1px solid #ccc;background-color: #f9f9f9;">
												...
												<?php if(is_array($status_list)): $i = 0; $__LIST__ = $status_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
														...
														<td><?php echo ($vo['conversion_rate']); ?></td>
														<td><?php echo ($vo['sum_money']); ?></td>
													</tr><?php endforeach; endif; else: echo "" ;endif; ?>
												<tr>
													<td>总计</td>
													<td><?php echo ($total_info['total_count']); ?></td>
													<td></td>
													<td><?php echo ($total_info['total_money']); ?></td>
												</tr>
											</table>
										</div>
									</div><?php endif; ?>
...
<script type="text/javascript">
	...
	//商机漏斗对比
	$(function () {
		<?php if(is_array($duibi_array)): $k = 0; $__LIST__ = $duibi_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>$('#sales_funnel_<?php echo ($k); ?>').highcharts({
				chart: {
					type: 'funnel',
					marginRight: 100
				},
				...
				series: [{
					...
					data: [<?php echo ($vo['status_count_array']); ?>]
				}]
