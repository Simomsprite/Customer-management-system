									...
									<?php if(!empty($fields)): ?><thead>
										...
										<?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
												...
												<td>
													...
													<?php if($vo['field'] == 'status_id' && $vo['model'] == 'business'): ?><a target="_blank" href="<?php echo U('setting/businesstype');?>"><?php echo L('SPECIAL_SETTING');?></a>
													<?php elseif($vo['field'] == 'category_id' && $vo['model'] == 'product'): ?>
														<a target="_blank" href="<?php echo U('product/category');?>"><?php echo L('SPECIAL_SETTING');?></a><?php endif; ?>
...
$(function(){
	...
	$("#add").click(function(){
		...
		$("#dialog_field_add").load('<?php echo U("setting/fieldadd","model=$model");?>'+'&status='+status);
	});
	$(".edit").click(function(){
