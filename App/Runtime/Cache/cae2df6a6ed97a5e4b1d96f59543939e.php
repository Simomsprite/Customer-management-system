...
<div class="wrap-box">
  <header class="abe-header am-header-default"> <a href="javascript:history.go(-1)" class="return iconfont">&#xe612;</a>
    <h1 class="abe-header-title">客户操作</h1>
  </header>
    <div class="clue">
        <input type="hidden" id="contents" name="<?php echo ($content); ?>" value="<?php echo ($content); ?>"/>
        <ul class="clue-head">
            <input type="hidden" id="customer_id" name="<?php echo ($customer_id); ?>" value="<?php echo ($customer_id); ?>"/>
            <li class="pd0">
               <div class="info"> <a href="<?php echo U('Customerm/indexctm',array('customer_id'=>$customer_id));?>" class="abe-block vi-blue"><i class="iconfont abe-ft24 mrg_10">&#xe608;</i><?php echo ($customer['name']); ?></a><em class="arrow iconfont">&#xe607;</em></div>
            </li>
            <li><span class="tit">客户负责人:</span><div class="info"><?php echo ($customer['owner']['full_name']); ?></div></li>
            <li><span class="tit">联系人姓名:</span><div class="info"><?php echo ($customer['contacts_name']); ?></div></li>
            <li><span class="tit">联系电话:</span><div class="info"><a href="tel:10086" class="abe-block"><em class="iconfont ztpos vi-blue abe-ft24 mrg_10">&#xe606;</em><?php echo ($customer['contacts_telephone']); ?></a></div></li>
        </ul>
        <div class="tab-box clue-tab">
        <ul class="tab-title">
            <li><a href="#.html" class="active">沟通日志</a></li>
            </ul>
        <div class="clue-faq tab-content">
            <div class="clue-item item" style="display: ">
                <?php if(is_array($log_list)): $i = 0; $__LIST__ = $log_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="bop-list">
                        <li class="uhbox"><em class="uhead"><img src="<?php echo ($vo['owner']['thumb_path']); ?>">alt=""></em><div><span class="pdr_10"><?php echo ($vo['owner']['full_name']); ?></span></div></li>
                        <li><span class="abe-gray3">联系时间：</span><?php echo (date("Y-m-d H:i",$vo["create_date"])); ?></li>
                        <li class="vi-blue"><?php echo ($vo['content']); ?></li>
                        <li><span class="abe-gray3">下次联系时间：</span><?php if($vo['nextstep_time']): echo (date("Y-m-d H:i",$vo['nextstep_time'])); endif; ?></li>
                        <li><span class="abe-gray3">联系方式：<?php echo ($vo['status_name']); ?></span></li>
                    </ul><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <!--<div class="clue-item item" style="display: "><ul class="bop-list">
                    <li class="uhbox"><em class="uhead"><img src="images/uhead.jpg" alt=""></em><div><span class="pdr_10">Fivege</span><span>销售经理</span></div></li>
                    <li><span class="abe-gray3">新建合同时间：</span>2019-09-03 15:16:00</li>
                    <li><span class="abe-gray3">客户名称：</span>王泽鉴</li>
                    <li><span class="abe-gray3">合同金额：</span>23000.00</li>
                    <li><span class="abe-gray3">截止时间：</span>2019-09-03 15:16:00</li>
                </ul><ul class="bop-list">
                    <li class="uhbox"><em class="uhead"><img src="images/uhead.jpg" alt=""></em><div><span class="pdr_10">Fivege</span><span>销售经理</span></div></li>
                    <li><span class="abe-gray3">新建合同时间：</span>2019-09-03 15:16:00</li>
                    <li><span class="abe-gray3">客户名称：</span>王泽鉴</li>
                    <li><span class="abe-gray3">合同金额：</span>23000.00</li>
            ...
            <div class="clue-item item" style="display: ">4</div>
    ...
    <div class="faq-btn-box">
        <a href="<?php echo U('Customerm/log_add', array('id' => $business_id[0],'customer_id' => $customer_id));?>"><i class="iconfont">&#xe6b3;</i>添加日志</a>
        <a href="#"><i class="iconfont">&#xe651;</i>添加签到</a>
        <?php if($content != 'resource'): ?><a href="<?php echo U('Customerm/edit',array('customer_id'=>$customer_id));?>"><i class="iconfont">&#xe600;</i>编辑</a>
            <?php else: ?><a href="javascript:showtab(3,'是否领取该条客户数据')"><i class="iconfont">&#xe600;</i>领取</a>
            <input type="hidden" name="operating_type" id="operating_type" value=""/><?php endif; ?>
        <a href="javascript:showtab(3,'是否删除该条数据')"><i class="iconfont">&#xe609;</i>删除</a>
    </div>
    ...
    <script>
        ...
        function closetab(){
            ...
            var customer_id=$("#customer_id").val()
            $.ajax({
                url:"<?php echo U('Customerm/receive');?>",
                type:"POST",
                data:{'content':content,'customer_id':customer_id},
                async: true,
                success:function(){
