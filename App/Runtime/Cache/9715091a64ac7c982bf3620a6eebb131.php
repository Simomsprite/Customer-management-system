...
<div class="wrap-box">
  <header class="abe-header am-header-default"> <a href="javascript:history.go(-1);" class="return iconfont">&#xe612;</a>
    <h1 class="abe-header-title">客户详情</h1>
  </header>
<div id="pagetwo" style="display: block">
    <ul class="cust-form">
        <li class="titbox"><span class="tit">客户负责人：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($username['name']); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">下次联系时间：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php if($customer["nextstep_time"] != '0'): echo (date('Y-m-d H:i',$customer["nextstep_time"])); ?>"<?php else: ?>无<?php endif; ?>">
            </div>
        </li>

        <li class="titbox"><span class="tit">客户名称：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["name"]); ?>">
            </div>
        </li>

        <li class="titbox"><span class="tit">客户电话：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["crm_vwlnfx"]); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">客户编号：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["customer_code"]); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">客户状态：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["customer_status"]); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">客户行业：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["industry"]); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">客户地址：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["address"]); ?>">
            </div>
        </li>
        <li class="titbox"><span class="tit">客户信息来源：</span>
            <div class="txtbox">
                <input type="text" class="txt ptxt100p" readonly="readonly" value="<?php echo ($customer["origin"]); ?>">
            </div>
        </li>
