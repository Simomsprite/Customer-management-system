(function(root, factory) {
    ...
    var defaults = {
            ...
            data: [ {date: '2017/11/28', value: '面试'},{date: '2017/11/29', value: '面试2'} ],
        ...
        MARK_DAY_HTML = '<i class="man-zx"><b>5</b>台</i>',
        ...
        TEMPLATE = [
			...
			'<div class="calendar-hd" style="display:block">',
            '<a href="javascript:;" data-calendar-display-date class="calendar-display">',
            '{yyyy}<span class="m">{mm}</span>',
            '</a>',
            '<div class="calendar-arrow">',
            '<span class="prev" title="上一月" data-calendar-arrow-date><i class="iconfont">&#xe612;</i></span>',
            '<span class="next" title="下一月" data-calendar-arrow-date><i class="iconfont">&#xe607;</i></span>',
            '</div>',
            '</div>',
