...
function(a) {
    ...
    a.extend(a.validator, {
        ...
        prototype: {
            init: function() {
                ...
                function(b, d) {
                    ...
                    a(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox'], [type='mobile'], [type='phone']", "focusin focusout keyup", b).validateDelegate("select, option, [type='radio'], [type='checkbox']", "click", b),
        ...
        methods: {
            ...
            mobile: function(a, b) {
            	return this.optional(b) || /^1[3456879][0-9]{9}$/.test(a)
            },
            phone: function (a, b) {
                return this.optional(b) || /^[0-9]{7,16}?$/.test(a)
            },
            url: function(a, b) {
